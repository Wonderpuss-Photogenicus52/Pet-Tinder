    ...
    <div className="d-flex justify-content-center mt-5 ">
      ...
      <form action='http://localhost:4000/signup' >
        ...
        <div className="p-3 d-flex flex-column justify-content-center border border-dark p-2 bg-light signupbox" style={{ maxWidth: '600px', borderRadius: '20px' }}>
          ...
          {/* username input box  */}
          <input name='password ' className="form-control form-control-lg mt-1" type="text" password='password' placeholder="password" aria-label=".form-control-lg example" />
          {/* password input box */}
          ...
          <textarea name='bio ' className='form-control-lg mb-4 bio-text' rows="" cols=""></textarea>
